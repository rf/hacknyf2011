...
function render_etsy_prod()
{
	...
	for (var i = 0; i <= 2; i++)
		html = html+'<td class="choice-desc"><a target="_new" href="'+etsy_prod[i].url+'">'+etsy_prod[i].name.substring(0, 100)+'</a> ($'+etsy_prod[i].price+')</td>';
...
function render_hp_food()
{
	...
	for (var i = 0; i <= 2; i++)
		html = html+'<td class="choice-desc"><b><a target="_new" href="'+hp_food[i].url+'">'+hp_food[i].name.substring(0, 100)+'</a></b> ('+interpret_price(hp_food[i].price)+')<br />'+hp_food[i].address+'</td>';
...
function render_hp_places()
{
	...
	for (var i = 0; i <= 2; i++)
		html = html+'<td class="choice-desc"><b><a target="_new" href="'+hp_places[i].url+'">'+hp_places[i].name.substring(0, 100)+'</a></b> ('+interpret_price(hp_places[i].price)+')<br />'+hp_places[i].address+'</td>';
...
function render_hp_hotel()
{
	...
	for (var i = 0; i <= 2; i++)
		html = html+'<td class="choice-desc"><b><a target="_new" href="'+hp_hotel[i].url+'">'+hp_hotel[i].name.substring(0, 100)+'</a></b> ('+interpret_price(hp_hotel[i].price)+')<br />'+hp_hotel[i].address+'</td>';
...
function generate_results()
{
	...
	html += '<tr><td class="color"><b>Basic</b> <a target="_new" href="'+etsy_prod[etsy_prod_sel].url+'">'+etsy_prod[etsy_prod_sel].name+'</a> ($'+etsy_prod[etsy_prod_sel].price+')</td></tr>';
	html += '<tr><td class="color_alt"><b>Frolicking</b> <a target="_new" href="'+hp_places[hp_places_sel].url+'">'+hp_places[hp_places_sel].name+'</a><br />'+hp_places[hp_places_sel].address+'</td></tr>';
	html += '<tr><td class="color"><b>Dining</b> <a target="_new" href="'+hp_food[hp_food_sel].url+'">'+hp_food[hp_food_sel].name+'</a><br />'+hp_food[hp_food_sel].address+'</td></tr>';
	html += '<tr><td class="color_alt"><b>Evening</b> <a target="_new" href="'+hp_hotel[hp_hotel_sel].url+'">'+hp_hotel[hp_hotel_sel].name+'</a><br />'+hp_hotel[hp_hotel_sel].address+'</td></tr>';
	html += '</table>';
